		...
		<div align="center">
			<center>
				<table style="width:942px; height: 30px;" cellpadding="0"
					...
					<tr>
						<td
							style="width: 518px; background-color: #ffffcc; text-align: left;">
							您好！网上订餐更快~更方便~ &nbsp;&nbsp;&nbsp;&nbsp;
							 &nbsp;
						...
						<td
							style="width: 512px;background-color: #ffffcc; text-align: right;">
							&nbsp; 订餐如此快乐，快把我加入收藏吧！
